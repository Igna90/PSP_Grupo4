...
urlpatterns = [
    ...
    path('sClient/', login_required(views.SClientView.as_view()), name='sClient'),
    path('searchClient/', login_required(views.SearchClientView.as_view()), name='searchClient'),
    path('listThisProject/<int:pk>', login_required(views.ListProjctView.as_view()), name='listThisProject'),
    ...
    path('api/login/',views.TestView.as_view()), 
    #PDF
